...
#         for document_name, document_info in document_based_structure.items():
...
#                 requirements = document_info.get('requirements', [])
...
#         requirement_tasks.append(process_document_object(requirement, document_name, assistant))
